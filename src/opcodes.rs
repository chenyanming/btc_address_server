...
/// Synonym for OP_RETURN
pub const OP_RETURN_186: u8 = 0xba;
/// Synonym for OP_RETURN
...
/// Synonym for OP_RETURN
pub const OP_RETURN_255: u8 = 0xff;
...
impl TryFrom<u8> for OpPushNum {
    ...
    fn try_from(m: u8) -> Result<Self, Self::Error> {
        match m {
            ...
            8 => Ok(OpPushNum::Op8),
            9 => Ok(OpPushNum::Op9),
            10 => Ok(OpPushNum::Op10),
            11 => Ok(OpPushNum::Op11),
            12 => Ok(OpPushNum::Op12),
            13 => Ok(OpPushNum::Op13),
...
impl From<OpPushNum> for u8 {
    fn from(code: OpPushNum) -> u8 {
        match code {
            OpPushNum::Op1 => OP_PUSHNUM_1,
            OpPushNum::Op2 => OP_PUSHNUM_2,
            OpPushNum::Op3 => OP_PUSHNUM_3,
            OpPushNum::Op4 => OP_PUSHNUM_4,
            OpPushNum::Op5 => OP_PUSHNUM_5,
            OpPushNum::Op6 => OP_PUSHNUM_6,
            OpPushNum::Op7 => OP_PUSHNUM_7,
            OpPushNum::Op8 => OP_PUSHNUM_8,
            OpPushNum::Op9 => OP_PUSHNUM_9,
            OpPushNum::Op10 => OP_PUSHNUM_10,
            OpPushNum::Op11 => OP_PUSHNUM_11,
            OpPushNum::Op12 => OP_PUSHNUM_12,
            OpPushNum::Op13 => OP_PUSHNUM_13,
            OpPushNum::Op14 => OP_PUSHNUM_14,
            OpPushNum::Op15 => OP_PUSHNUM_15,
            OpPushNum::Op16 => OP_PUSHNUM_16,
        }
    }
}
